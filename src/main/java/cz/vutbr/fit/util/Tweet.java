...
public class Tweet implements Serializable {
	...
	private float score;
	private Date date;
	private Annotation textAnnot;
	private Annotation authorAnnot;
	...
	*/
	...
	public Annotation getTextAnnot() {
		return textAnnot;
	}

	public void setTextAnnot(Annotation textAnnot) {
		this.textAnnot = textAnnot;
	}

	public Annotation getAuthorAnnot() {
		return authorAnnot;
	}

	public void setAuthorAnnot(Annotation authorAnnot) {
		this.authorAnnot = authorAnnot;
	}
}
